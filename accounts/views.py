    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            messages.success(
                ...
                "before logging in. Check your inbox and spam folder.",
            )
...
def user_profile(request, username):
    ...
    is_followed_by = (
        request.user in profile_user.profile.following.all()
    )
...
def followers_list(request, username):
    ...
    can_view = (
        profile_user == request.user
        or profile_user in request.user.profile.following.all()
    )
